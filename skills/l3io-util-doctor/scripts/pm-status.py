...
# ///
# pm-status-version: 2.4.10   (machine-readable marker; `self-install` compares this across copies — keep at top)
"""
...
PM_STATUS_VERSION = "2.4.10"  # keep in sync with the top-of-file `# pm-status-version:` marker
