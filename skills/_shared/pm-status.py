...
# ///
# pm-status-version: 3.1.0   (machine-readable marker; `self-install` compares this across copies — keep at top)
"""
...
PM_STATUS_VERSION = "3.1.0"  # keep in sync with the top-of-file `# pm-status-version:` marker
