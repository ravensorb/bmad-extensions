...
# ///
"""
First Breath — Deterministic sanctum scaffolding for l3io-sec-agent-redteam.
...
SKILL_NAME = "l3io-sec-agent-redteam"
...
def main():
    parser = argparse.ArgumentParser(
        description="First Breath — create sanctum structure for l3io-sec-agent-redteam.",
    ...
    result["created"].append(f"CAPABILITIES.md ({len(capabilities)} capabilities)")
