---
name: platform-best-practices-research
description: Research current cloud/platform best practices violations using live web search, with a cached memory layer to avoid redundant queries
code: PBR
---
