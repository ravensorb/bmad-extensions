---
name: scope-and-surface-mapping
description: Map the attack surface before analysis — entry points, trust boundaries, data flows, auth checkpoints, persistent state, and AI/ML components
code: SM
---
