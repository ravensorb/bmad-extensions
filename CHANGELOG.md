...
* **infra:** add check-docs check 20, shared-files-table ([fb536fb](https://github.com/ravensorb/bmad-extensions/commit/fb536fb78f332fb82bf52c0e4e50d0cc14b00764))
* **infra:** add check:module, the guard Phase 2's invariant needs ([014e0ca](https://github.com/ravensorb/bmad-extensions/commit/014e0ca3a11f82e6dd32d659c3649ef7aa315eac))
...
* **l3io-util:** add per-epic fixture files (force-add past _bmad/ gitignore) ([1bf731f](https://github.com/ravensorb/bmad-extensions/commit/1bf731ff18663ad380f61313930aada1aecbdd09))
* **l3io-util:** add the overlay mode, owner of the BMad customization layer ([3997537](https://github.com/ravensorb/bmad-extensions/commit/3997537325f00725c01781bfb2a227a336c3de40))
* **l3io-util:** derive dependency truth from BMad's own manifest ([f1aad4a](https://github.com/ravensorb/bmad-extensions/commit/f1aad4af3d62db4237f29c4ffa1facce40be3ec0))
* **l3io-util:** derive records from story artifacts, sprints inferred ([c126a7a](https://github.com/ravensorb/bmad-extensions/commit/c126a7a807b93e91a8be12236a7df55c58cf2f35))
* **l3io-util:** detect a project holding both state layouts ([85ef3d0](https://github.com/ravensorb/bmad-extensions/commit/85ef3d05058fac532d2221403b95ad4c1f77557b))
* **l3io-util:** detect-layout classifies a flat status file by schema ([47ec169](https://github.com/ravensorb/bmad-extensions/commit/47ec1690c84d0081f100cc9f0a9700393f2c4a71))
* **l3io-util:** migration engine, read-only half ([79a9412](https://github.com/ravensorb/bmad-extensions/commit/79a9412f814f5319184c845dc40937e129d14a2f))
* **l3io-util:** reader for base BMad's development_status mapping ([1cc47d1](https://github.com/ravensorb/bmad-extensions/commit/1cc47d15b7878094ceb035af7f69bd47e9df22ed))
* **l3io-util:** reader for the legacy flat epics: list ([49a54d0](https://github.com/ravensorb/bmad-extensions/commit/49a54d011640efa17547b2ad485c10bd321143ba))
* **l3io-util:** reader for the legacy per-epic _bmad/state layout ([9168c43](https://github.com/ravensorb/bmad-extensions/commit/9168c43b05493b4f198628857bb588a014acad87))
* **l3io-util:** reader for the split three-file status layout ([8161aad](https://github.com/ravensorb/bmad-extensions/commit/8161aad0d24e6858af234d956312a4eb010cb271))
* **l3io-util:** register the doctor's three entry points and record the exclusions ([6ecf49d](https://github.com/ravensorb/bmad-extensions/commit/6ecf49db9b3de6e7e35f35b68b450e0016eee599))
* **l3io-util:** remove the deprecated l3io-util-cleanup forwarder ([52263f2](https://github.com/ravensorb/bmad-extensions/commit/52263f29dabea81c14b2e8d6fe1a24abfc01c828))
* **l3io-util:** stats surfaces the clear-lock remedy, watch hint, and dwell note ([012e52c](https://github.com/ravensorb/bmad-extensions/commit/012e52c4edf5bbe4b9eee0e8c626de58d3b39e57))
* **l3io-util:** the gate, the write, and verification against the plan ([085a32f](https://github.com/ravensorb/bmad-extensions/commit/085a32fedb83cc9d687dfbed7cfdd73dc68127bc))
* **l3io-util:** the normalised record every doctor reader emits ([3a91c4a](https://github.com/ravensorb/bmad-extensions/commit/3a91c4a30d371ce73ecf9f59edc2368076e08515))


### Fixes

* **ci-cd:** consolidate GitHub Actions on current, act-verified versions ([e97d59b](https://github.com/ravensorb/bmad-extensions/commit/e97d59b223ad4b800589a3e9f1c43ed691e78d3d))
* **ci:** close the command-chain hole in check 17's uv-run exemption (F-1) ([df65633](https://github.com/ravensorb/bmad-extensions/commit/df65633a895cbea7490d7aabbc0f0cf265fb18c8))
* **ci:** close two new holes in check 17's F-1 fix, and its pre-existing cheap exit (N-1, N-2, N-3) ([6060984](https://github.com/ravensorb/bmad-extensions/commit/6060984f806da1d13816d77e0818604e84c7ac5d))
* **ci:** constrain check 17's token skip to flag shapes so prose stops tripping it (R-1) ([b5366a4](https://github.com/ravensorb/bmad-extensions/commit/b5366a40c8cf6b55b201d8d165904a8fed318c65))
* **ci:** stop provisioning pm-status.py tests via ambient pip, add check:module gate ([9a89874](https://github.com/ravensorb/bmad-extensions/commit/9a8987424b4a025ea6372ce545ff791c2562e2ce))
* **ci:** widen check 17's python3 predicate past interpreter flags and minor versions (M-1) ([a798f0b](https://github.com/ravensorb/bmad-extensions/commit/a798f0b398d2942317b5ba9591235ef2a65a9e2e))
* **infra:** add check 19 to guard the check count, per review round 1 ([37a5795](https://github.com/ravensorb/bmad-extensions/commit/37a5795aca39a26f585c339edd2ec6fcf86c5a3b))
* **infra:** check 4 no longer misjudges doctor keywords or other tools' subcommands ([8802696](https://github.com/ravensorb/bmad-extensions/commit/8802696281f1b6a346ca8b5287f3c55da5162534))
* **infra:** close eleven of checks 4 and 17's KNOWN GAPS, and re-measure the rest ([ecb83f9](https://github.com/ravensorb/bmad-extensions/commit/ecb83f9af96a966d250585b230895f440d6f55de))
* **infra:** close remaining setup-routing drift and guard against orphaned payload ([0994181](https://github.com/ravensorb/bmad-extensions/commit/0994181006f9d7dc9a885cdd67c3c89d1f9ed160))
* **infra:** close Task 7 fix-round-1 findings — renumbering, module-setup path, version guard ([b70021f](https://github.com/ravensorb/bmad-extensions/commit/b70021f9f74471c6e252190920262a3bc3b2627d))
* **infra:** derive check 22's "on disk" from git, not the filesystem ([18bd1c4](https://github.com/ravensorb/bmad-extensions/commit/18bd1c42c8b89f3f7a5215ba25ef4884cc90b081))
* **infra:** derive check 4's completeness set, and document the 12 subcommands it found ([7cfac87](https://github.com/ravensorb/bmad-extensions/commit/7cfac87582af8298d2e1cbbeb9f22b201fd84fd4))
* **infra:** drop two module-help flags that are implemented nowhere ([71bb8c2](https://github.com/ravensorb/bmad-extensions/commit/71bb8c2602639bb16f451e63fa5c200a4401205e))
* **infra:** extend check 17 to the live docs, and fix the 17 python3 invocations it found ([2e23f75](https://github.com/ravensorb/bmad-extensions/commit/2e23f7561bf27137065b0d87f8473d583eb83f03))
* **infra:** filter allSkillDirs to directories, not just l3io- names (F-8) ([4b721f1](https://github.com/ravensorb/bmad-extensions/commit/4b721f19ecace69e2ff9f44cb258895708ee7758))
* **infra:** invoke PEP-723 helpers with uv, as BMad does ([5d04e1b](https://github.com/ravensorb/bmad-extensions/commit/5d04e1b70cccd82447cab4e84b63c848d494dc8f))
* **infra:** make smoke:install able to pass again, and guard overlay's cp ([0d2ce74](https://github.com/ravensorb/bmad-extensions/commit/0d2ce748362b10693a033df6cf2014b88e60970b))
* **infra:** make the module-contract smoke check state-derived ([e3784c8](https://github.com/ravensorb/bmad-extensions/commit/e3784c89e686da6a761b636ad187d190ee7b5cb1))
* **infra:** narrow check 26 regex to require state-context tokens ([bf208ae](https://github.com/ravensorb/bmad-extensions/commit/bf208ae13922bbb43c7d23d1b7ff3032b87aebed))
* **infra:** one action and phase vocabulary, _meta rows, and the documented relationships ([e52272f](https://github.com/ravensorb/bmad-extensions/commit/e52272f5db2799271783b972829caa99cd864684))
* **infra:** pin check 17's python3 arity model, and correct four claims about it ([04a9e41](https://github.com/ravensorb/bmad-extensions/commit/04a9e41f6ea9cde22b1d2c97111e9f7f09148cf7))
* **infra:** qualify the bare-binding anchor on code formatting, and finish the migrate-state set ([c788a1e](https://github.com/ravensorb/bmad-extensions/commit/c788a1e0bab7f5e8982722ba378dfea423301e1f))
* **infra:** read a `\`-continued invocation whole, and broaden smoke's negative twin ([dfc8123](https://github.com/ravensorb/bmad-extensions/commit/dfc81235a9b89da3ca826bd34f8c3fae32bf5e31))
* **infra:** rebuild check 17 on a YAML and a shell parser, and check 21 in process ([98eb328](https://github.com/ravensorb/bmad-extensions/commit/98eb3283f72c3446fd5883d2a9e5ce7f996c2ff8))
* **infra:** smoke:install judges validate-module.py's findings, not its verdict ([03ddfdf](https://github.com/ravensorb/bmad-extensions/commit/03ddfdf41eaee2ecedc936f0ca34573478eaba7b))
* **infra:** walk docs/ recursively, so the ADRs are inside the checks at all ([b08c39f](https://github.com/ravensorb/bmad-extensions/commit/b08c39f4dc2f2323a9ea0ac11dca204d2602f325))
* **infra:** widen check 17's preference detection past binding verbs ([7a4ddab](https://github.com/ravensorb/bmad-extensions/commit/7a4ddab97a2e35fdc5b95e763f65d10dfb1152fe))
* **l3io-arch:** correct the arch-review row's args, output location and phase ([cc9469c](https://github.com/ravensorb/bmad-extensions/commit/cc9469cc3ef2f53c3e3a4f7196436a93fa7e8b70))
* **l3io-pm:** adr-reserve refuses rather than guessing when it cannot scan the ADR home ([aa83716](https://github.com/ravensorb/bmad-extensions/commit/aa837160341b5bba95e349fc3cb750dd6db261a8))
* **l3io-pm:** check 21 also validates description, per Task 11A re-review ([7a51105](https://github.com/ravensorb/bmad-extensions/commit/7a51105f6e7437d4e800c6b7482244e47a9174b5))
...
* **l3io-util:** sweep the .v1 calibration backup where pm-status.py actually writes it ([5f6d286](https://github.com/ravensorb/bmad-extensions/commit/5f6d286b0b42e9e836dc42b3020b60e793d04c93))
* **l3io-util:** three dependencies are deprecated, not removed ([f6a5593](https://github.com/ravensorb/bmad-extensions/commit/f6a559351f0293c7faf45126418a86064e6615cf))
* **l3io-util:** triage no longer refuses the case Check 13 flags it for ([f982888](https://github.com/ravensorb/bmad-extensions/commit/f98288897f208da503174de82d1a6bf301c3a992))
* **l3io-util:** update-ai-rules creates the running AI's file, never another's ([07bdcf6](https://github.com/ravensorb/bmad-extensions/commit/07bdcf676d110502e01ba7d807d916da39d7eb47))
* **l3io:** put module.yaml where BMad's installer actually discovers it ([49f5ff1](https://github.com/ravensorb/bmad-extensions/commit/49f5ff183d16d93b421ff59c3cf8a5c4d138d3a7))
* **l3io:** remove phantom module-help.csv rows, guard the class in check:module (F-4) ([6d8b5a0](https://github.com/ravensorb/bmad-extensions/commit/6d8b5a00e489e0afd037ab5bf5c47158314f9928))


### Refactoring

* **infra:** check:module parses module.yaml and module-help.csv with libraries ([2bc7708](https://github.com/ravensorb/bmad-extensions/commit/2bc7708d0fb524c428351959b05fc8fc5b5bc906))
* **infra:** exempt description-only prose from check 26; suppress 5 read-only state probes ([835634b](https://github.com/ravensorb/bmad-extensions/commit/835634b05138f1326de1891c5520e88e484ea281))
* **infra:** exempt SKILL.md, test files, python comments, and docstrings from check 26 ([0ac2f7b](https://github.com/ravensorb/bmad-extensions/commit/0ac2f7b4bce4ac2c9064e3332621b9f6fd9392bd))
* **infra:** one module.yaml per module, under assets/ ([38a3c83](https://github.com/ravensorb/bmad-extensions/commit/38a3c8398c3f4d30ef830e39821b0337fe897d06))
...
* **l3io-util:** fold the backlog doctor mode into stats ([275f376](https://github.com/ravensorb/bmad-extensions/commit/275f37616f1db2849784d19080bb99fa0e1c6c4c))
* **l3io-util:** migrate-state is prose around the engine ([f24b69d](https://github.com/ravensorb/bmad-extensions/commit/f24b69d9fb823a02650f4f17d9527c41e6d13c93))
* **l3io-util:** remove the normalize doctor mode ([0c0df13](https://github.com/ravensorb/bmad-extensions/commit/0c0df13f2fcca4cd0a507218ae1ca1e15b33665d))


### Documentation

* correct eleven verified claims across the root docs and references ([22e817f](https://github.com/ravensorb/bmad-extensions/commit/22e817f036f0c23f57ba507fefbb2cb4ca776cc0))
* correct follow-up marker count from 5 to 2 ([5827073](https://github.com/ravensorb/bmad-extensions/commit/5827073b580a69d94cef7be7f5eb081f46914542))
* **infra:** resolve every cross-skill pointer in the shared files, and gate the class ([72f6df4](https://github.com/ravensorb/bmad-extensions/commit/72f6df4f9e3fbef0ef47b802b8b7e9031d366fe3))
...
* **l3io-util:** tidy the stats alias list in the doctor's mode overview ([8cf0989](https://github.com/ravensorb/bmad-extensions/commit/8cf098971dce6d3709b271a415f341236b70d9fa))
* **l3io:** add Task 0B — derive the skill and module counts ([51ec26c](https://github.com/ravensorb/bmad-extensions/commit/51ec26c7eb5ec5dd82cbac8e6e76baa929e0358f))
...
* **l3io:** finish correcting the stale setup-step claim (F-2, F-3) ([0ae759d](https://github.com/ravensorb/bmad-extensions/commit/0ae759d4f7183bf2ba51db2dc3797d5eab8087c8))
* **l3io:** fix Task 0's edit set and drop a task solving a non-problem ([f46f6bc](https://github.com/ravensorb/bmad-extensions/commit/f46f6bcca7f7283ce83c129ce4684736d5a4ac6d))
* **l3io:** fix three more assumptions the plan was standing on ([e1a28f0](https://github.com/ravensorb/bmad-extensions/commit/e1a28f0cfdf869b54076873a3f7e020b6e467f82))
* **l3io:** full pre-development verification sweep ([d76de93](https://github.com/ravensorb/bmad-extensions/commit/d76de9373892f3d9b8f04354318cdec9baf32a4b))
* **l3io:** plan Phases 1-2 of the customization-layer design ([f79ed6d](https://github.com/ravensorb/bmad-extensions/commit/f79ed6d0e54baec5a383008eef5f229a950d5115))
* **l3io:** record ADR-0008, the module packaging shape ([48c65c1](https://github.com/ravensorb/bmad-extensions/commit/48c65c1b13274a808cceb6a5899207024e8c9398))
* **l3io:** revise the plan after auditing it against recorded decisions ([7112a18](https://github.com/ravensorb/bmad-extensions/commit/7112a18f17cc30378267ddf1daa0e6caa1941789))
* **l3io:** use uv as BMad does, ship one pm-status.py per module, prove every task ([e841324](https://github.com/ravensorb/bmad-extensions/commit/e84132431cc321899bbd29afbadbc6cadd42c623))
* point at where the artifact schema actually lives ([2fb414d](https://github.com/ravensorb/bmad-extensions/commit/2fb414d4ad4c3ba908e4761e1f0515534d16a477))
* README no longer advertises the removed `overlay` doctor keyword ([a9d0444](https://github.com/ravensorb/bmad-extensions/commit/a9d04447eec14f7c2a639b274ab0f3848a39c17b))
* record the module.yaml discovery contract read from project-root.js ([9d0a4ac](https://github.com/ravensorb/bmad-extensions/commit/9d0a4ac7bfa96281a3186e3932e3474ff5ed6ca8))
* redact machine paths and dead scratch pointers ([b015c32](https://github.com/ravensorb/bmad-extensions/commit/b015c32f8cf17436ed6421627fb8e58a3e30a717))
* sync user-facing docs with the l3io-util-required + check-pm-status changes ([1ebbc47](https://github.com/ravensorb/bmad-extensions/commit/1ebbc47a7aa85982801e850abd1071c8756c8f19))
* the doctor's migrations are an engine, not prose ([15fcdff](https://github.com/ravensorb/bmad-extensions/commit/15fcdffb70118a748e8c4cf6c9990d4591509739))
* trim derivable content from CLAUDE.md and split out scripts/ ([b17e9aa](https://github.com/ravensorb/bmad-extensions/commit/b17e9aa85c1a7d5fac5a96724171bec7ba2ed288))


### Testing

* **infra:** close check 4's three measured escapes, and gate marketplace.json's dependencies ([b0495fb](https://github.com/ravensorb/bmad-extensions/commit/b0495fbe4540de00b662e81cea2f15278ee83b2f))
* **infra:** pin the seven check-17 decisions an 81-mutation sweep found unpinned ([549a2f5](https://github.com/ravensorb/bmad-extensions/commit/549a2f5078349e9527dcc83b422fe2bdd7ce498f))
* **infra:** run the real config resolver in smoke:install, and guard its workdir ([ca18707](https://github.com/ravensorb/bmad-extensions/commit/ca187077402ae329b2c2c4938fdf8486b6320027))
* **l3io-pm:** assert the notice lock ordering in-process, deleting the timing margin ([02d5d92](https://github.com/ravensorb/bmad-extensions/commit/02d5d925eb8ae2e285eba1a88661f5689420e476))
* **l3io-pm:** replace the tuned notice race test with a deterministic one, finish the prose sweep ([374baae](https://github.com/ravensorb/bmad-extensions/commit/374baae09f0e31820ddba32109f7f02805f6c724))
