---
name: "l3io-sec-setup"
description: Sets up LiquidLogicLabs Security Red Team module in a project. Use when the user requests to 'install l3io-sec module', 'configure LiquidLogicLabs Security Red Team', or 'setup LiquidLogicLabs Security Red Team'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/l3io-sec/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code l3io-sec
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code l3io-sec --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
