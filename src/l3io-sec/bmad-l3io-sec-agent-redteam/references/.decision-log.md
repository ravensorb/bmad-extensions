---
skill: bmad-l3io-sec-agent-redteam
phase: complete
...
**research-cache/ in sanctum.** Cache lives at `{project-root}/_bmad/memory/bmad-l3io-sec-agent-redteam/research-cache/`. The init script creates this directory. INDEX.md has a Research Cache section the agent maintains as cache inventory.
