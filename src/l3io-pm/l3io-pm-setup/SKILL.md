---
name: "l3io-pm-setup"
description: Sets up LiquidLogicLabs PM Orchestration module in a project. Use when the user requests to 'install l3io-pm module', 'configure LiquidLogicLabs PM Orchestration', or 'setup LiquidLogicLabs PM Orchestration'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/l3io-pm/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code l3io-pm
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code l3io-pm --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
