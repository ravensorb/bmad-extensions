...
- If `l3io-sec-agent-redteam` is installed (check `.claude/skills/l3io-sec-agent-redteam/SKILL.md` or `.claude/commands/l3io-sec-agent-redteam.md`): add 15–25 min, 30–60K tokens
