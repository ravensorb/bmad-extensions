...
| `npm run check:docs` | Documentation matches the code it describes — twenty-four checks, including that every documented CLI subcommand exists and every `<file>.md §N` cross-reference resolves |
